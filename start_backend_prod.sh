...
LIMIT_CONCURRENCY="$(strip_cr "${TWILIGHT_UVICORN_LIMIT_CONCURRENCY:-1000}")"
BACKLOG="$(strip_cr "${TWILIGHT_UVICORN_BACKLOG:-2048}")"
KEEP_ALIVE="$(strip_cr "${TWILIGHT_UVICORN_KEEP_ALIVE:-2}")"
